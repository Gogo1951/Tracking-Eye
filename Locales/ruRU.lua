...
L["OPTIONS_HOOK_BLIZZARD_NOTE"] =
	"Когда эта опция включена, кнопка отслеживания Blizzard открывает Меню отслеживания, которое меняет только то, что вы отслеживаете. Все остальное остается здесь, в интерфейсе настроек."
L["OPTIONS_HOOK_BLIZZARD_DESC"] =
	"Открывает Меню отслеживания при нажатии на кнопку отслеживания Blizzard у миникарты. Оставьте отключенным, если другой аддон уже использует эту кнопку."
