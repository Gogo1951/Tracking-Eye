...
-- Options Panel
L["OPTIONS_DESC"]                = "Умное меню отслеживания, автоматически переключающее поиск трав и руды во время езды верхом и восстанавливающее способность отслеживания после смерти."
