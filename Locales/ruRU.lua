...
L["TRACKING_MENU_DESC"] =
	"Показывает список способностей отслеживания и позволяет выбрать способность для постоянного отслеживания."
...
L["PERSISTENT_DESC"] =
	"Автоматически восстанавливает заклинание отслеживания после воскрешения и смены облика."
...
L["OPTIONS_COMMANDS_INTRO"] =
	"Слеш-команды для Tracking Eye. Панель настроек содержит все необходимое; это для тех, кто предпочитает использовать клавиатуру."
...
L["OPTIONS_FARM_NOTE"] =
	"Примечание: Режим фарма работает только вне боя, когда вы не применяете заклинания и находитесь вне городов, таверн и подземелий."
...
L["OPTIONS_ICON_SCALE_DESC"] =
	"Масштаб значка отслеживания при использовании Свободного перемещения."
