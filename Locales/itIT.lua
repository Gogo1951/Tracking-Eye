...
L["TRACKING_MENU_DESC"] =
	"Visualizza un elenco delle tue abilità di tracciamento e imposta l'Abilità di Tracciamento Persistente."
...
L["PERSISTENT_DESC"] =
	"Rilancia automaticamente l'incantesimo di tracciamento dopo la resurrezione e il mutamento di forma."
...
L["OPTIONS_COMMANDS_INTRO"] =
	"Comandi slash per Tracking Eye. Il pannello delle opzioni copre tutto ciò di cui hai bisogno; questi sono qui per chi preferisce la tastiera."
...
L["OPTIONS_FARM_NOTE"] =
	"Nota: la Modalità Raccolta funziona solo mentre sei fuori dal combattimento, non stai lanciando incantesimi e sei fuori da città, locande e istanze."
