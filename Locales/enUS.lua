...
L["FARMING_DESC"] = "Cycles between Herbs and Minerals while mounted or in travel form."
...
L["TOOLTIP_OPTIONS_HINT"] = "Additional options are available under Options > AddOns > Tracking Eye."

-- Options Panel
L["OPTIONS_ALWAYS_ON"]           = "(Always On)"
