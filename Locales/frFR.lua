...
L["TRACKING_MENU_DESC"] =
	"Affiche une liste de vos capacités de pistage et définit la capacité de pistage persistant."
...
L["PERSISTENT_DESC"] =
	"Relance automatiquement votre sort de pistage après une résurrection et un changement de forme."
...
L["OPTIONS_COMMANDS_INTRO"] =
	"Commandes slash pour Tracking Eye. Le panneau d'options couvre tout ce dont vous avez besoin ; celles-ci sont là pour les adeptes du clavier."
...
L["OPTIONS_FARM_NOTE"] =
	"Remarque : Le mode de collecte ne fonctionne que lorsque vous êtes hors combat, que vous ne lancez pas de sorts et en dehors des villes, auberges et instances."
